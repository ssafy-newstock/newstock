...
def summaryLLM(
   ...
   너는 내가 준 대한민국 코스피의 {start_date} ~ {end_date} 기간 내 {stock_code} 종목을 내가 준 뉴스 및 의 주가 가격을 고려해서 시황 및 종목 분석 보고서를 작성해 줘야해.
    ...
    9.1 뉴스 id는 related_news에 담아줘 (ex. [20240101000000001, 20240102000000012, 20240102000000013, 20240102000000012]
    ...
    9. 마지막으로 너가 시황분석, 요약한 것과 가장 관련 있는, 도움이 많이 되었던 뉴스 4개를 뽑아 related_news에 담아. 주의해야 할 점은 뉴스 id만 가져와.
