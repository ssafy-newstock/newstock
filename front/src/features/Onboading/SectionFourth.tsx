...
import videoStockFirst from '@assets/OnBoarding/뉴스 조회.gif';
import videoStockSecond from '@assets/OnBoarding/뉴스 감정분석.gif';
import videoStockThird from '@assets/OnBoarding/뉴스 저장.gif';
