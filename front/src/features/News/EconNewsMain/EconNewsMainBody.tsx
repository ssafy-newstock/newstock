...
import NewsBodyFooter from './EconNewsBodyFooter';
import NewsBodyContent from './EconNewsBodyContent';
import NewsBodyTitle from './EconNewsBodyTitle';
import NewsBodyHeader from './EconNewsBodyHeader';
