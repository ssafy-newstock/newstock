...
import com.ssafy.member.entity.oauth.CustomOAuth2User;
...
//        return getAuthentication(accessToken).getMemberName()
//                .equals(getAuthentication(refreshToken).getMemberName());
    }
