...
public class StocksPriceLiveDailyChartRedis {
    @Id
    private String id;
    ...
    public StocksPriceLiveDailyChartRedis(String stockCode, String stockName, String stockIndustry, Long stckPrpr, LocalDateTime time) {
