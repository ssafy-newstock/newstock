    ...
    post {
        success {
            script {
                ...
                message: "Build Success: ${env.JOB_NAME} #${env.BUILD_NUMBER} by ${BUILD_USER_ID}(${BUILD_USER})\n(<${env.BUILD_URL}|Details>)",
        ...
        failure {
            script {
                ...
                message: "Build Failure: ${env.JOB_NAME} #${env.BUILD_NUMBER} by ${BUILD_USER_ID}(${BUILD_USER})\n(<${env.BUILD_URL}|Details>)",
                endpoint: 'https://meeting.ssafy.com/hooks/x91hu5m9gfy9mbp8ns8n1m5xqw',
                channel: 'newstock-jenkins'
                )
            }
